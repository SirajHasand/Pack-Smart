    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid sm:grid-cols-[1fr,120px,auto] gap-3">
        ...
        <div className="relative">
          <FiTag className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" />
          <input
            id="desc"
            type="text"
            value={description}
            ...
            className="w-full pl-10 rounded-xl border border-slate-200 dark:border-slate-700 
                       ...
                       py-3 outline-none focus:ring-4 ring-indigo-500/20 
        ...
        <input
          ...
          className="w-full rounded-xl border border-slate-200 dark:border-slate-700 
                     ...
                     text-slate-800 dark:text-slate-200 
                     placeholder-slate-400 dark:placeholder-slate-500
                     py-3 px-3 outline-none focus:ring-4 ring-indigo-500/20 
                     focus:border-indigo-500 transition"
        />
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 
                     ...
                     active:bg-indigo-600/90 shadow 
